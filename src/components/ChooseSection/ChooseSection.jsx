  ...
  return (
    <div>
        <div className="container">
            <h2 className='mb-5 text-center'>Why choose Nuwana Education Institute?</h2>
            <div className='row g-4'>
                
                <div className='col-lg-4'>
                    <Card className='border-0 d-flex align-items-center h-100'>
                        <div className='mt-3'>
                        ...
                        <Card.Body>
                            ...
                            At Nuwana Education Institute, student happiness is our priority. We create a positive and engaging learning environment where students feel supported and motivated. Our dedicated teachers and personalized approach ensure that each student enjoys their educational journey and achieves their academic goals.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
                <div className='col-lg-4'>
                    <Card className='border-0 d-flex align-items-center h-100'>
                        ...
                        <Card.Body>
                            <Card.Title className='mb-3 text-center text-capitalize'>
                                locations in Gampaha
                            </Card.Title>
                            <Card.Text className='text-center'>
                            Conveniently located in the heart of Gampaha, Nuwana Education Institute is easily accessible for all our students. Our central location provides a safe and welcoming atmosphere, making it easy for families to choose us as their trusted educational partner in the community.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </div>
