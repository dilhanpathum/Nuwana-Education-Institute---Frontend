    ...
    <Header/>
      ...
      <div class=" flex flex-col items-center justify-center px-6 py-8 mx-auto lg:py-0 ">
          <a href="#" class="flex items-center mb-4 text-2xl font-semibold text-gray-900 dark:text-white">
              <img class="w-50 h-60 mr-2" src={Logo} alt="logo"/>
          ...
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="#">
                  ...
                  <div>
                      <label for="confirm-password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Birth Day</label>
